...
$angryLevels = array(
    ...
    new LevelInformation("S1 - I WONDER","roundcat.spelunkysandboxsdemo",true,
    ...
    new LevelInformation("THE LONE AND LEVEL SANDS","SmallSpelunky.CANIA_DIAPHONY",true,
    ...
    new LevelInformation("ENEMY OF THE SUN","fnchannel.altgreed.enemyofsun",true,
        "03f5dc1f43772c345a05b2d5fb758462","fnchannel.altgreed.enemyofsun"),
    new LevelInformation("MINE ODDITY","ceo_of_gaming.overworld.1",true,
        "0678443fd37076d418830d6af625e54b","ceo_of_gaming.overworld.1"),
    new LevelInformation("TAKE BACK THE NIGHT","ceo_of_gami ng.overworld.2",true,
        "0678443fd37076d418830d6af625e54b","ceo_of_gaming.overworld.2"),
    new LevelInformation("NETHER REACHES","ceo_of_gaming.minecraft.nether",true,
    ...
    new LevelInformation("THE BEGINNING OF ETERNITY","Woosp.TheBeginningOfEternity",true,
    ...
    new LevelInformation("ON THE ROCKS","dubswrathlevel",true,
